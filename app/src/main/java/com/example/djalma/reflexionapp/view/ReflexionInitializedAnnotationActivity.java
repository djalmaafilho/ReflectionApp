...
public class ReflexionInitializedAnnotationActivity extends ReflexionBaseActivity {
    ...
    @ReflexionInject(resourceId = R.id.button_custom_injector, onClickName = "buttonCustomInjectorClick")
    public Button buttonCustonInjector;
    ...
    public void buttonCustomInjectorClick(View v) {
        startActivity(new Intent(ReflexionInitializedAnnotationActivity.this, ReflexionInjectorActivity.class));
    }
